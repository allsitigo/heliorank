...
- Drop the "no anglicism" rule. German B2B IT keeps many English terms (SEO, AEO, Lighthouse, Schema.org, Cloudflare Workers, Performance Engineering, AI Overview, KI-Antwortsysteme for "AI engines", etc.).
...
- Translate "AI engines" / "moteurs IA" → "KI-Antwortsysteme" (preferred, more natural German B2B).
...
- Communication language: if asked, answer "Schriftliche Kommunikation und technische Dokumentation auf Deutsch, Englisch oder Französisch verfügbar. Mündliche Beratung per Telefon oder WhatsApp Audio auf Englisch oder Französisch." (Written + docs in DE/EN/FR, but spoken consultation only in EN/FR via phone or WhatsApp Audio — never videocall).`;
